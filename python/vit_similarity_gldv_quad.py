...
checkpoint_path = "training_1/checkpoints/vit-similarity-gldv_quad/cp-{epoch:04d}.ckpt"
...
filename2 = "matrix/vit-gldv-similarity-quad-v2/matrix.npy"
...
model.load_weights("training_1/checkpoints/vit-similarity-gldv_quad/cp-0040.ckpt")
