...
checkpoint_path = (
    "training_1/checkpoints/resnet-similarity-gldv_quad/cp-{epoch:04d}.ckpt"
)
...
filename = "matrix/resnet-similarity-gldv-quad_v2/matrix.txt"
...
model.load_weights("training_1/checkpoints/resnet-similarity-gldv_quad/cp-0014.ckpt")
...
filename3 = "matrix/resnet-similarity-gldv-quad_v2/pred.txt"
