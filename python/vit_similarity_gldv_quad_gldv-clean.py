...
dataset_directory = "train_split_clean_100"
checkpoint_path = (
    "training_1/checkpoints/vit-similarity-gldv_quad_clean/cp-{epoch:04d}.ckpt"
)
...
def preprocess_image(image_path):
    ...
    img_array = _normalize_img(img_array)
    return img_array
...
filename2 = "matrix/vit-gldv-similarity-quad_clean-second-test/matrix.npy"
...
model.load_weights("training_1/checkpoints/vit-similarity-gldv_quad_clean/cp-0031.ckpt")
